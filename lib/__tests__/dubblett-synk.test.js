...
const KRAV = [
  ...
  { etikett: 'Ledtidsindex-snittet 46 mån (ersatte obelagda "44 mån median"; borta ur planavsnittet sedan 2026-09-07)', forekomster: [
    ['lokalforsorjning.html', '46 mån', 1],
    ['scripts/popular-slides.json', '46 mån', 1],
  ]},
  { nyckeltal: 'planledtid-kommunmedian-antagande', varde: '29 mån', forekomster: [
    ['lokalforsorjning.html', '29 mån', 1],
  ]},
