...
const GRUPPER = [
  {
    ...
    ingress:
      'Boverkets plan- och bygglovsenkät, publicerad kommun för kommun. Det enda område där Kolada mäter samma sak som guidens ledtidsargument. Underlaget avser bostadsplaner respektive bostadshus.',
  },
  {
    id: 'investering',
    namn: 'Investeringar och bestånd',
    ingress:
      'Kommunens investeringsutgifter och anläggningstillgångar, redovisade både för kommunen och för kommunkoncernen. Skillnaden mellan de två nivåerna är det närmaste Kolada kommer att mäta Lejonfastigheter: beståndet ligger i bolaget, inte i kommunens egen balansräkning. Kommunraden ensam är därför missvisande.',
  },
  {
    id: 'lokalkostnad',
...
const KATALOG = [
  ...
  { id: 'N03148', kort: 'Investeringsutgifter, kommunen totalt', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kostnadsmatt', riktning: 'ingen', percentil: true, liknande: LIKNANDE_OVRIGT, not: 'Avser kommunens egna investeringar. Kommunkoncernen omfattar de kommunala bolagen, alltså även Lejonfastigheter. Kommunraden och koncernraden ska läsas tillsammans — beståndet ligger i bolaget, inte i kommunens egen balansräkning.' },
  { id: 'N03150', kort: 'Investeringsutgifter, pedagogisk verksamhet', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kostnadsmatt', riktning: 'ingen', percentil: true, liknande: 'G35989', not: 'Skolor och förskolor. Ett lågt värde betyder inte att kommunen investerar lite i skollokaler — det betyder att investeringen ligger i bolaget. Kommunkoncernen omfattar de kommunala bolagen, alltså även Lejonfastigheter. Kommunraden och koncernraden ska läsas tillsammans — beståndet ligger i bolaget, inte i kommunens egen balansräkning.' },
  { id: 'N03160', kort: 'Investeringsutgifter, vård och omsorg', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kostnadsmatt', riktning: 'ingen', percentil: true, liknande: 'G176609', not: 'Vård- och omsorgsboenden samt LSS. Kommunkoncernen omfattar de kommunala bolagen, alltså även Lejonfastigheter. Kommunraden och koncernraden ska läsas tillsammans — beståndet ligger i bolaget, inte i kommunens egen balansräkning.' },
  { id: 'N03163', kort: 'Investeringsutgifter, kultur och fritid', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kostnadsmatt', riktning: 'ingen', percentil: true, liknande: LIKNANDE_OVRIGT, not: 'Idrottshallar, bibliotek och fritidsanläggningar.' },
  { id: 'N03166', kort: 'Investeringsutgifter, näringsliv och bostäder', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kostnadsmatt', riktning: 'ingen', percentil: true, liknande: LIKNANDE_OVRIGT, not: '' },
  ...
  { id: 'N03041', kort: 'Materiella anläggningstillgångar, kommunen', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kontextmatt', riktning: 'ingen', percentil: true, liknande: LIKNANDE_OVRIGT, not: 'Kommunens eget bestånd. Kommunkoncernen omfattar de kommunala bolagen, alltså även Lejonfastigheter. Kommunraden och koncernraden ska läsas tillsammans — beståndet ligger i bolaget, inte i kommunens egen balansräkning.' },
  ...
  { id: 'N03012', kort: 'Avskrivningar, kommunen', grupp: 'investering', enhet: 'kr/inv', decimaler: 0, klass: 'kontextmatt', riktning: 'ingen', percentil: true, liknande: LIKNANDE_OVRIGT, not: 'Redovisas som negativt tal i Kolada. Kommunkoncernen omfattar de kommunala bolagen, alltså även Lejonfastigheter. Kommunraden och koncernraden ska läsas tillsammans — beståndet ligger i bolaget, inte i kommunens egen balansräkning.' },
